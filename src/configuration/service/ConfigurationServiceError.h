...
make_error_code(scrap::Configuration::Service::ConfigurationServiceError e) noexcept;

// Enable automatic conversion to std::error_code
namespace std {
template <>
struct is_error_code_enum<scrap::Configuration::Service::ConfigurationServiceError> : true_type { };
}  // namespace std

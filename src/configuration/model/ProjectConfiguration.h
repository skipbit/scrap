...
[[nodiscard]] std::expected<ProjectType, dross::error> parseProjectType(const std::string& str) noexcept;
...
[[nodiscard]] std::expected<BuildSystem, dross::error> parseBuildSystem(const std::string& str) noexcept;
